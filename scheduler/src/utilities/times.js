...
export const getCourseTerm = codeOrCourse => {
  const code = typeof codeOrCourse === 'string'
    ? codeOrCourse
    : codeOrCourse?.code;
  return code ? terms[code.charAt(0)] : undefined;
};

export const getCourseNumber = code => (
  code.slice(1)
);
